          ...
          <section className="mb-16">
            <div className="w-full">
              ...
              <div className="flex items-start mb-8">
                ...
                <div className="flex-1 mt-4">
                  {/* Title */}
                  <h2 className={`text-3xl font-bold text-white`}>Technical Certifications in Computing &amp; Design</h2>
                </div>
              </div>
              ...
              <div className="space-y-8 mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 items-center">
                  <div className={`text-lg text-white`}>2025</div>
                  <div className={`text-lg text-white`}>Udemy</div>
                  <div className={`text-lg text-white`}>Human-Computer Interaction</div>
                </div>

                {/* Digital Product Management Certification Entry */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 items-center">
                  <div className={`text-lg text-white`}>2024</div>
                  <div className={`text-lg text-white`}>University of Virginia</div>
                  <div className={`text-lg text-white`}>Digital Product Management: Modern Fundamentals</div>
                </div>

                {/* Human-Centered Design Certification Entry */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 items-center">
                  <div className={`text-lg text-white`}>2024</div>
                  <div className={`text-lg text-white`}>University of California, San Diego</div>
                  <div className={`text-lg text-white`}>Human-Centered Design: An Introduction</div>
                </div>

                {/* Creative IT Certification Entry */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 items-center">
